...
const socialLinks = [
  ...
  // { icon: Mail, href: 'mailto:omar@example.com', label: 'Email' },
  { icon: MessageCircle, href: 'https://wa.me/+201114369970', label: 'WhatsApp' },
]
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-12">
          ...
          <Link href="#home" className="flex items-center ">
            <motion.div
              ...
              className="text-lg flex items-center gap-2 font-heading md:text-xl font-bold tracking-wide"
            >
              <motion.div
                initial={false}

                className={`flex items-center gap-1 overflow-hidden whitespace-nowrap pointer-events-auto`}
              >
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Senior Fullstack Web Developer specializing in React, Next.js, 
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-2 rounded-lg bg-muted hover:bg-yellow hover:text-yellow-foreground transition-colors"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Omar Eldesouky. All rights reserved.
          </p>
          <motion.button
            onClick={scrollToTop}
            whileHover={{ scale: 1.1, y: -2 }}
